class TransactionAccountsController < ApplicationController
  ...
  def create
    ...
    if @transaction_account.save
      redirect_to @transaction_account, notice: 'Transaction account was successfully created.'
    else
      render :new
    end
  end
  ...
  def update
    if @transaction_account.update(transaction_account_params)
      redirect_to @transaction_account, notice: 'Transaction account was successfully updated.'
    else
      render :edit
    end
  end
  ...
  def destroy
    ...
    redirect_to transaction_accounts_url, notice: 'Transaction account was successfully destroyed.'
  end
  ...
  private
    ...
    def transaction_account_params
      params.require(:transaction_account).permit(:name)
    end
end
