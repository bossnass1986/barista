Strongbolt.setup do |config|
  ...
  #
  config.models = 'PgSearch::Document', 'User', 'HABTM_Roles', 'Address', 'AddressType', 'Batch', 'Cart', 'CartItem', 'Country', 'Coupon', 'Image', 'Invoice', 'ItemType', 'Merchant', 'Order', 'OrderItem', 'OrderStatus', 'Payment', 'PaymentProfile', 'Phone', 'PhoneType', 'Product', 'ProductProperty', 'ProductType', 'Property', 'Prototype', 'PrototypeProperty', 'Referral', 'ReferralBonus', 'ReferralProgram', 'ReferralType', 'Role', 'HABTM_Users', 'ShippingRate', 'ShippingRateType', 'ShippingZone', 'State', 'StoreCredit', 'TaxRate', 'TradingHour', 'Transaction', 'TransactionAccount', 'TransactionLedger', 'Variant', 'VariantMerchant', 'VariantProperty'
end