...
class BatchesControllerTest < ActionController::TestCase
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post :create, batch: { batchable_id: @batch.batchable_id, batchable_type: @batch.batchable_type, name: @batch.name }
    end
  ...
  test "should update batch" do
    patch :update, id: @batch, batch: { batchable_id: @batch.batchable_id, batchable_type: @batch.batchable_type, name: @batch.name }
    assert_redirected_to batch_path(assigns(:batch))
  end
