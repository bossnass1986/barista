...
RSpec.describe CartItemsController, type: :controller do
  ...
  describe "GET #terms" do
    it "assigns the requested cart_item as @cart_item" do
      cart_item = CartItem.create! valid_attributes
      get :terms, {:id => cart_item.to_param}, valid_session
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created cart_item" do
        post :create, {:cart_item => valid_attributes}, valid_session
        expect(response).to redirect_to(CartItem.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved cart_item as @cart_item" do
        post :create, {:cart_item => invalid_attributes}, valid_session
        expect(assigns(:cart_item)).to be_a_new(CartItem)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested cart_item" do
        cart_item = CartItem.create! valid_attributes
        put :update, {:id => cart_item.to_param, :cart_item => new_attributes}, valid_session
        cart_item.reload
      ...
      it "redirects to the cart_item" do
        cart_item = CartItem.create! valid_attributes
        put :update, {:id => cart_item.to_param, :cart_item => valid_attributes}, valid_session
        expect(response).to redirect_to(cart_item)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the cart_item as @cart_item" do
        cart_item = CartItem.create! valid_attributes
        put :update, {:id => cart_item.to_param, :cart_item => invalid_attributes}, valid_session
        expect(assigns(:cart_item)).to eq(cart_item)
      end
