...
describe ProductsController do
  ...
  describe "GET new" do
    it "assigns a new product as @product" do
      ...
      assigns(:products).should be_a_new(Product)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Product" do
        expect {
          post :create, {:products => valid_attributes}, valid_session
        }.to change(Product, :count).by(1)
      end

      it "assigns a newly created product as @product" do
        post :create, {:products => valid_attributes}, valid_session
        assigns(:products).should be_a(Product)
        assigns(:products).should be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved product as @product" do
        ...
        post :create, {:products => { "name" => "invalid value" }}, valid_session
        assigns(:products).should be_a_new(Product)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested product" do
        ...
        put :update, {:id => menu_item.to_param, :products => { "name" => "MyString" }}, valid_session
      end

      it "assigns the requested product as @product" do
        menu_item = Product.create! valid_attributes
        put :update, {:id => menu_item.to_param, :products => valid_attributes}, valid_session
        assigns(:products).should eq(menu_item)
      end
    ...
    describe "with invalid params" do
      it "assigns the product as @product" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Product.any_instance.stub(:save).and_return(false)
        put :update, {:id => menu_item.to_param, :products => { "name" => "invalid value" }}, valid_session
        assigns(:products).should eq(menu_item)
      end
